...
public class ArrayQueue {
    ...
    {
        // resizes the array when its full
    ...
    public Player remove() // dequeue
    {
        ...
        if(size() == 0) // resize trackers when queue is empty
        {
            front = 0;
            back = 0;
        }
    ...
    public Player peek() // gets item infront of the queue
    {
        if(size() == 0)
        {
            throw new NoSuchElementException();
